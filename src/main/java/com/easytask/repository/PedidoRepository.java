...
public interface PedidoRepository extends JpaRepository<Pedido, Long> {
    ...
    List<Pedido> findAllByStatusAndUsuario_UsernameNotAndAndServico_CategoriaOrderByDataInicio(Status status, String username, CategoriaServico categoria);
    Page<Pedido> findAllByStatusAndUsuario_UsernameNotAndAndServico_CategoriaOrderByDataInicio(Status status, String username, CategoriaServico categoria, Pageable pageable);
